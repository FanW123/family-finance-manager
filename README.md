...
一个专为 FIRE (Financial Independence, Retire Early) 目标设计的财务管理和追踪应用。帮助您规划、追踪并实现财务自由之路。

## 核心理念

FirePath 不仅仅是一个记账软件，更是您通往财务自由的指南针。通过精准的支出追踪、智能的预算分析和科学的投资组合管理，助您早日实现 FIRE 目标。
